...
test.describe('version history', () => {
  test('history page loads with "Version History" heading', async ({ page, history }) => {
  ...
  test('history page shows edit sessions after typing in a document', async ({ page, history }) => {
  ...
  test('clicking a history group loads a read-only preview', async ({ page, history }) => {
  ...
  test('"Document created" entry is visible at the bottom of the list', async ({ page, history }) => {
  ...
  test('expanding an accordion reveals sub-items', async ({ page, history }) => {
  ...
  test('restore flow: restoring a version lands on the study page with correct content', async ({ page, history, editor }) => {
  ...
  test('history link in the study editor navigates to the history page', async ({ page, history }) => {
